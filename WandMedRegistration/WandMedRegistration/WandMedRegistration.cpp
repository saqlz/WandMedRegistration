// WandMedRegistration.cpp : 定义控制台应用程序的入口点。
//
...
namespace
{
	...
	int DoIt(int argc, char *argv[])
	{
		...
		std::string fixedImage = "D:\\1.nrrd";
		std::string movingImage = "D:\\2.nrrd";
		...
		*/
		...
		std::vector<std::vector<float>> fixedLandmarks;
		std::vector<std::vector<float>> movingLandmarks;
		std::string initialization = "CentersOfMass";
		...
		int rigidMaxIterations = 100;
		int affineMaxIterations = 50;
		int bsplineMaxIterations = 20;
		...
		double rigidSamplingRatio = 0.01;
		...
		double affineSamplingRatio = 0.02;
		...
		double bsplineSamplingRatio = 0.1;
